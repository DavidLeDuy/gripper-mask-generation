...
class GripperConfig(Config):
    """Configuration for training on thetoy  dataset.
    Derives from the base Config class ad overrides some values.
    """
    # Give the configuration a recognizale name
    NAME = "gripper"
...
class GripperDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image(
                "gripper",
                image_id=a['filename'],  # e file name as a unique image id
                path=image_path,
