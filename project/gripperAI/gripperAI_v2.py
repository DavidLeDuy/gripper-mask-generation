...
from mrcnn.model import log, data_generator
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("gripperAI", 1, "würfel")
        self.add_class("gripperAI", 2, "zylinder")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "gripperAI":
        ...
        # plt.imshow(mask[:, :, 0],cmap=plt.cm.binary, alpha=0.5)
        # if mask.shape[2] > 1:
        #     plt.imshow(mask[:, :, 1],cmap=plt.cm.binary, alpha=0.5)
        # plt.show()
...
def train(model):
    ...
    # generator = data_generator(dataset_train, config, shuffle=True,
    #                                    augmentation=None,
    #                                    batch_size=1,
