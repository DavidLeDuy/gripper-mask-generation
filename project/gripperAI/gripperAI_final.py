...
Usage: import the module (run fromthe command line as such:
    ...
    python gripperAI_new.py train --dataset=/PATH/TO/dataset --weights=coco

    #Train a new model starting from pre-trained ImageNet weights
    python gripperAI_new.py train --dataset=/PATH/TO/dataset --weights=imagenet

    # Continue training the last model you trained. This will find
    # the last trained weights in the model directory.
    python gripperAI_new.py train --dataset=/PATH/TO/dataset --weights=last
    ...
    python gripperAI_new.py splash --weights=last --image=/home/...../*.jpg

    #Detect and color splash on a video with a specific pre-trained weights of yours.
    python gripperAI_new.py splash --weights=gripperAImodel_final.h5  --video=test_video.mp4
"""
